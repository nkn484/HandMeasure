...
interface FingerAnchorFactory {
    fun createAnchor(pose: TryOnHandPoseSnapshot): TryOnFingerAnchor?
}

class DefaultFingerAnchorFactory : FingerAnchorFactory {
